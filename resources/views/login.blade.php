    ...
    <main class="main" style="min-height: 100vh; display: flex; align-items: center; justify-content: center; background: var(--background);">
        <div class="card" style="max-width: 400px; width: 100%;">
            <div class="card-header" style="text-align: center;">
                ...
                <p class="card-description">Accede a tu cuenta para gestionar tus tareas y notas.</p>
            </div>
            <form method="POST" action="{{ route('login') }}" style="padding: 1.5rem 0;">
                @csrf
            ...
            <div style="text-align:center; margin-top:1rem;">
                <a href="{{ route('register') }}" class="nav-link">¿No tienes cuenta? Regístrate</a>
            </div>
        </div>
    </main>
</body>
